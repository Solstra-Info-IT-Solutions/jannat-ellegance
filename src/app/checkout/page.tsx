      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_380px]">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-3xl border border-maroon-100 bg-white p-6 sm:p-8">

              <h2 className="font-serif text-2xl text-maroon-950">
                Delivery Partner
              </h2>

              <div className="mt-5 flex items-center gap-4 rounded-2xl border border-maroon-100 bg-maroon-50/50 p-5">

                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-maroon-800">
